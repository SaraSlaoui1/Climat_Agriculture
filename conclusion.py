...
def conclusion_function():
 ...
 st.markdown("Les résultats montrent une **diminution de la période de montaison (stade 3) en 2100**, qui pourrait donc amener à une **récolte plus faible.** De plus, en analysant les moyennes de température et précipitations pour les années étudiées et prédites, on constate que bien que l'année 2019 est été en moyenne la plus sèche, les précipitations lors de la phase de germination ont été plus importantes, cela pourrait expliquer une montaison plus longue et donc un meilleur rendement.")
