...
def conclusion_function():
 ...
 st.markdown("J'ai choisi de cibler **le blé car il représente une denrée alimentaire essentielle pour l'humanité** et un bon rendement est donc crucial. L'étude phénologique du blé se base sur la **mise en relation des dates attendues des différents stades par rapport aux dates observées**. Pour les années concernées, on observe déjà un décalage, **souvent les stades sont précoces**(ils commencent trop tôt ou finissent plus tôt que prévus), ce qui est communément **signe de températures plus élevées que la moyenne de saison** et les stades 1 et 2 durent plus longtemps que la moyene. En cherchant plus loin la signification et l'importance de chaque stade, j'ai pu apprendre qu'en agriculture, **le stade de montaison est déterminant pour la récolte. Si ce stade est plus court, les épis seront moins denses donc produiront moins de grains**. C'est comme ça que j'ai pu établir le lien entre les rendements de 2018 à 2020 en constatant que **2019 était l'année la plus productive car le stade 3 était plus long pour la majorité des plantes observées.**") 
